    ...
    <section className="py-20">
      <div className="w-11/12 max-w-6xl mx-auto">
        ...
        >
          <motion.p
            variants={fadeUp}
            className="text-primary uppercase tracking-[0.3em] font-semibold"
          >
            Education
          </motion.p>
          <motion.h2
            variants={fadeUp}
            className="text-4xl font-bold text-base-content mt-3"
          >
            Academic Journey
          </motion.h2>
          <motion.p
            variants={fadeUp}
            className="text-base-content/80 mt-4 max-w-3xl mx-auto"
          >
        ...
        <motion.div
          ...
          whileInView="visible"
          viewport={{ once: false, amount: 0.3 }}
          className="relative border-l-2 border-primary pl-8 space-y-10"
        >
          {educations.map((item, index) => (
            <motion.div
              key={index}
              variants={fadeUp}
              className="relative bg-base-200 rounded-2xl border border-base-300 p-6 hover:border-primary transition-all duration-300"
            >
              <div className="absolute -left-[42px] top-8 w-5 h-5 rounded-full bg-primary border-4 border-base-100"></div>
              ...
              <h4 className="text-lg text-secondary font-medium mt-1">
                {item.institute}
              </h4>
          ...
          >
            {certificates.map((certificate, index) => (
              <motion.div
                key={index}
                variants={fadeUp}
                className="bg-base-200 rounded-2xl border border-base-300 p-6 hover:border-primary hover:-translate-y-2 transition-all duration-300"
              >
                ...
                <p className="text-base-content/80 mt-4 leading-7">
                ...
                <Link
                  ...
                  target="_blank"
                  className="btn bg-primary text-black border-0 hover:bg-cyan-400 mt-6"
                >
                  View Certificate
                </Link>
              </motion.div>
